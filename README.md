...
- `globals.executable`: Executable for running the scripy. This could either be left empty (`null`), or for example with the [Apptainer](https://apptainer.org/documentation/) image that we provide in the supplementary data.
